        ...
        <div class="card-header">
            ...
            <form method="GET" action="{{ route('productos.index') }}" class="row g-2 align-items-end">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <input type="search" name="buscar" class="form-control" placeholder="Código, nombre o presentación"
                            ...
                            <td>
                                <div class="record-person compact-person">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <a href="{{ route('productos.show', $producto->id_producto) }}" class="record-name">
                                            {{ $producto->nombre }}
                                        </a>
                            ...
                            <td class="text-end text-nowrap">
                                ...
                                <div class="table-actions justify-content-end">
                                    ...
                                    <a href="{{ route('productos.show', $producto->id_producto) }}"
                                        class="btn btn-sm btn-light border" title="Ver producto">
                                        <i class="bi bi-eye"></i>
                                    </a>

                                    <a href="{{ route('productos.edit', $producto->id_producto) }}"
                                        class="btn btn-sm btn-light border" title="Editar producto">
